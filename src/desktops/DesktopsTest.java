...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException{
        ...
        mouseHoverToBuild(By.xpath("//span[normalize-space()='Currency']"));
        clickMethod(By.xpath("//span[normalize-space()='Currency']"));

        //Mouse hover on £Pound Sterling and click
        mouseHoverToBuild(By.xpath("//button[normalize-space()='£Pound Sterling']"));
        clickMethod(By.xpath("//button[normalize-space()='£Pound Sterling']"));
        ...
        //Select product “HP LP3065”
        clickMethod(By.xpath("//a[normalize-space()='HP LP3065']"));
        ...
        clickMethod(By.xpath("//div[@class='input-group date']//button[@type='button']"));
        while (true){
            ...
            if (mon.equalsIgnoreCase(month) && yer.equalsIgnoreCase(year)){
                ...
                clickMethod(By.xpath("//div[@class='datepicker-days']//th[@class='next'][contains(text(),'›')]"));
            }
        }
        // select the date
