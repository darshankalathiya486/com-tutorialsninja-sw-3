...
public class MyAccountsTest extends Utility {
    ...
    public void VerifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "Darshan");
        sendTextToElement(By.id("input-lastname"), "Kalathiya");
        sendTextToElement(By.id("input-email"), "darshanr@gmail.com");
        sendTextToElement(By.id("input-telephone"), "07877229988");
        ...
        String aMsg = getTextFromElement(By.xpath("//h1[normalize-space()='Your Account Has Been Created!']"));
    ...
    public void VerifyThatUserLoginAndLogoutSuccessfully() {
        ...
        sendTextToElement(By.id("input-email"), "darshan@gmail.com");
        sendTextToElement(By.id("input-password"), "Prime@123");
        clickOnElement(By.xpath("//input[@type = 'submit']"));
